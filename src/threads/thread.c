...
thread_set_priority (int new_priority) 
{
  ...
  struct thread * ready_list_head, * current_thread;
...
{
  return fixed_to_int_near (mul (fixed (100), load_avg));
}
...
{
  return fixed_to_int_near (mul (fixed (100), thread_current ()->recent_cpu));
}

